// ignore_for_file: camel_case_types, prefer_interpolation_to_compose_strings, constant_identifier_names

class Image_utils {
  static const base = 'assets/images/';
  static const applogo = base + 'logo.png';
  static const google_logo = base + 'google_logo.png';
  static const facebook_logo = base + 'facebook_logo.png';
  static const mail_logo = base + 'mail.png';
  static const visibility = base + 'visibility.png';
  static const visibility_off = base + 'visibility_off.png';
